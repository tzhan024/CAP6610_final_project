...
dataset = load_dataset('alexfabbri/multi_news', trust_remote_code=True)['train']
...
if __name__ == "__main__":
    ...
    print("datetime: >>>>>> ", dt)
    with open(f'outputs/multinews_result_{eval_model}_{compress_rate}_{start}to{end}_{dt}.json', 'w') as f:
